...
def test_agent_config_sets_active_path(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr("nanobot.providers.factory.make_provider", lambda _config: object())
...
def _patch_cli_command_runtime(
    ...
    *,
    ...
    monkeypatch.setattr(
        ...
        lambda _config, _model=None: provider_factory(_config),
    )
    monkeypatch.setattr(
    ...
    monkeypatch.setattr(
        ...
        lambda _config, _model=None: _test_provider_snapshot(provider_factory(_config), _config),
    )
    monkeypatch.setattr(
...
def test_gateway_cron_evaluator_receives_scheduled_reminder_context(
    ...
    monkeypatch.setattr(
        "nanobot.providers.factory.build_provider_snapshot",
        lambda _config, _model=None: _test_provider_snapshot(provider, _config),
    )
    monkeypatch.setattr(
        "nanobot.providers.factory.load_provider_snapshot",
...
def test_gateway_cron_job_suppresses_intermediate_progress(
    ...
    monkeypatch.setattr(
        "nanobot.providers.factory.build_provider_snapshot",
        lambda _config, _model=None: _test_provider_snapshot(object(), _config),
    )
    monkeypatch.setattr(
        "nanobot.providers.factory.load_provider_snapshot",
