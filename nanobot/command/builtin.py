...
BUILTIN_COMMAND_SPECS: tuple[BuiltinCommandSpec, ...] = (
    ...
    BuiltinCommandSpec(
        "/compact",
        "Compact / switch compact model",
        "Compact conversation, or pass a model to switch the compact model.",
        "minimize-2",
        "[--switch] [model]",
    ),
    BuiltinCommandSpec(
    ...
    BuiltinCommandSpec(
        "/model",
        "Show/switch model",
        "Show the current model or switch to another configured model.",
        "cpu",
        "[number|name]",
    ),
    BuiltinCommandSpec(
